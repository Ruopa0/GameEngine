// src/lib.rs for cb_shared crate
// This crate provides shared component definitions used across the codebase.
// All component structs and related enums originally defined in cb_weapons::components
// are moved here under the components module.
...
pub mod components {
    ...
    /// Tag to prevent entity from being despawned on lethal damage
    ...
    impl Magazine {
        ...
        pub fn try_fire(&mut self) -> bool {
            if self.current > 0 && !self.is_reloading { self.current -= 1; true } else { false }
        }
